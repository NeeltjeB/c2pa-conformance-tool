        ...
        <div class="flex items-center justify-start flex-1">
          {#if report || processing || currentPage !== 'main'}
            <h1>
              ...
              >
                <span class="h-[38px] w-6 overflow-hidden" aria-hidden="true">
                  <img src="/content_credentials_icon.svg" alt="" class="h-full w-auto max-w-none dark:invert" />
                </span>
                C2PA Verify
      ...
      <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-12 mt-10">
        <div class="mb-10">
          <h2 class="inline-flex items-center justify-center gap-3 text-3xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4 tracking-wide leading-tight">
            <img src="/c2pa_icon.svg" alt="" class="h-8 w-8 sm:h-10 sm:w-10 dark:invert" />
            Content Credentials
          </h2>
